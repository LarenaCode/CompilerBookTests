...
#include "Lexico/AnalizadorLexico.h"
...
void AnalysisManager::insertReservedWords(TablaSimbolosInizializador * t) {
...
void AnalysisManager::analizar(std::string file) {
	AnalizadorLexico lex(file);
